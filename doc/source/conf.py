...
# -*- coding: utf-8 -*-
#
# linreg_helpers documentation build configuration file, created by
...
modindex_common_prefix = ["linreg_helpers"]
...
basename = "linreg_helpers".replace(" ", "").replace(".", "")
